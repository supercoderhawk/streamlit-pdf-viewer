...
BASIC_EXAMPLE_FILE = os.path.join(ROOT_DIRECTORY, "tests", "streamlit_apps", "example_iframe_width.py")
...
def test_should_render_template_check_container_size(page: Page):
    expect(page.get_by_text("Test PDF Viewer using legacy iframe with specified width")).to_be_visible()
